#ifndef C2SSA_PASSMANAGERBUILDER_H
#define C2SSA_PASSMANAGERBUILDER_H
...
public:
  ...
  llvm::TargetLibraryInfoImpl *LibraryInfo;
  ...
  /// tests.
  llvm::ModuleSummaryIndex *ExportSummary = nullptr;
  ...
  /// tests.
  const llvm::ModuleSummaryIndex *ImportSummary = nullptr;
...
private:
  void addExtensionsToPM(ExtensionPointTy ETy,
                         llvm::legacy::PassManagerBase &PM) const;
  void addInitialAliasAnalysisPasses(llvm::legacy::PassManagerBase &PM) const;
  void addLTOOptimizationPasses(llvm::legacy::PassManagerBase &PM);
  void addLateLTOOptimizationPasses(llvm::legacy::PassManagerBase &PM);
  void addPGOInstrPasses(llvm::legacy::PassManagerBase &MPM, bool IsCS);
...
public:
  ...
  void populateLTOPassManager(llvm::legacy::PassManagerBase &PM);
  void populateThinLTOPassManager(llvm::legacy::PassManagerBase &PM);
};
