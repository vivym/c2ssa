...
/// lives here.
class c2ssa::sroa::AllocaSliceRewriter
...
/// SROA pass.
class c2ssa::sroa::SROAPass : public FunctionPass {
...
FunctionPass *c2ssa::createSROAPass() { return new SROAPass(); }

namespace c2ssa {

#define C2SSA_INITIALIZE_PASS_END(passName, arg, name, cfg, analysis)                \
...
INITIALIZE_PASS_BEGIN(SROAPass, "sroa",
                      "Scalar Replacement Of Aggregates", false, false)
INITIALIZE_PASS_DEPENDENCY(AssumptionCacheTracker)
INITIALIZE_PASS_DEPENDENCY(DominatorTreeWrapperPass)
C2SSA_INITIALIZE_PASS_END(SROAPass, "sroa", "Scalar Replacement Of Aggregates",
                    false, false)
