...
const int UnrollThresholdAggressive = std::numeric_limits<unsigned>::max();
const int UnrollThresholdDefault = std::numeric_limits<unsigned>::max();
const int UnrollOptSizeThreshold = 0;
const int UnrollMaxIterationsCountToAnalyze = 10;
const int UnrollMaxUpperBound = 8;
const int PragmaUnrollThreshold = 16 * 1024;
const int FlatLoopTripCountThreshold = 5;
...
TargetTransformInfo::UnrollingPreferences gatherUnrollingPreferences(
  ...
  UP.MaxPercentThresholdBoost = std::numeric_limits<unsigned>::max();
  ...
  bool OptForSize = L->getHeader()->getParent()->hasOptSize() ||
                    shouldOptimizeForSize(L->getHeader(), PSI, BFI,
...
static LoopUnrollResult tryToUnrollLoop(
  ...
  bool Convergent;
  TargetTransformInfo::UnrollingPreferences UP = c2ssa::gatherUnrollingPreferences(
  ...
  unsigned LoopSize =
      c2ssa::ApproximateLoopSize(L, NumInlineCandidates, NotDuplicatable, Convergent,
  ...
  bool IsCountSetExplicitly = c2ssa::computeUnrollCount(
